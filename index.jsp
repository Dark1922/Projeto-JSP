...
<body>
		...
		<div class="container-login100" style="background-image: url('resources/login/images/bg-01.jpg');">
			<div class="wrap-login100">
				<form class="login100-form validate-form" class="login-form"  action="LoginServlet" method="post">
					...
					<div class="wrap-input100 validate-input" data-validate = "Enter username">
						<input class="input100" id="login" type="text" name="login" placeholder="Username">
					...
					<div class="container-login100-form-btn">
						<button class="login100-form-btn" type="submit" value="Logar">
							Login
						</button>
					</div>
